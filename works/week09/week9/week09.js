...
console.log("Добро " + "пожаловать, " + "Анастасия");
//Задание 5
...
const totalMinutes = 128 + 254 + 137 + 201;
...
const janitorSalary = 40000;
const vocalTeacherSalary = 22000;
const totalSalary = janitorSalary + vocalTeacherSalary;
...
let value = "15";
console.log(value); // как строка
value = Number(value);
console.log(value); // как число
